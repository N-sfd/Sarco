...
export const heroSlides = [
  {
    id: "slide-1",
    title: "Top-Rated Appliances,\nDelivered & Installed Fast",
  ...
  {
    id: "slide-2",
    title: "Unlock Exclusive Rebates\n& Appliance Savings",
    ...
    href: "/rebates",
    secondaryCta: { label: "View Financing", href: "/financing" },
  ...
  {
    id: "slide-3",
    title: "Local Appliance Experts\nFrom Purchase to Repair",
    ...
    secondaryCta: { label: "Check Availability", action: "service-modal" as const },
