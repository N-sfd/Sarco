...
export const heroSlides = [
  {
    id: "slide-1",
    title: "In Stock & On Sale",
    text: "Find major appliances available for fast local delivery.",
  ...
  },
  {
    ...
    text: "Save when you purchase multiple kitchen or laundry appliances.",
    cta: "Shop Appliance Packages",
    href: "/kitchen-packages",
    image: siteImages.heroPackages,
  },
  {
    id: "slide-3",
    title: "Buy Now, Pay Later",
    text: "Flexible financing with approved credit.",
    cta: "View Financing Options",
    href: "/financing",
    image: siteImages.heroFinancing,
  },
  {
    id: "slide-4",
    title: "Professional Appliance Repair",
    text: "Factory-trained technicians servicing major household appliance brands.",
    cta: "Schedule Repair",
...
export const reviews = [
  ...
  },
  {
    name: "Priya S.",
    rating: 5,
    text: "Financing was straightforward and the laundry pair we chose was in stock at the Frederick store.",
    source: "Google",
    verified: true,
  },
  {
